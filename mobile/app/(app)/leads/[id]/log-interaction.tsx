...
/**
 * Placeholder for the post-call interaction logging screen.
 * The full quick form (voice-to-text, prompt after call) lands in CB-53 (S3-6).
 */
    ...
    <SafeAreaView style={styles.screen}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.subtitle}>
          Logging an interaction for this lead will be available soon (CB-53).
        </Text>
