...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* ── Left panel ── */}
      <div
        className="hidden lg:flex lg:w-[45%] flex-col px-16 py-12 relative overflow-hidden"
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse at 40% 50%, rgba(59,99,214,0.35) 0%, transparent 65%)',
          }}
        />

        {/* Logo top-left */}
        <div className="relative z-10 flex items-center gap-3">
          <img src={logo} alt="Coding Bootcamps ESPOL" className="w-12 h-12 object-contain" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center">
          <h1 className="text-6xl font-extrabold text-white leading-none mb-4">
            Boot-<span className="text-[#5B9BD5]">tracker</span>
          </h1>
          <p className="text-white/60 text-lg">The best tool to track your leads</p>
        </div>
      </div>
