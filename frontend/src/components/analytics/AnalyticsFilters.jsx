...
const EMPTY = { fecha_desde: '', fecha_hasta: '', segment: '', campaign: '' }
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-4 sm:p-5 mb-6">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <label htmlFor="analytics-campana" className="block text-sm font-medium text-gray-700 mb-1">
            Campaña
          </label>
          <input
            id="analytics-campana"
            type="text"
